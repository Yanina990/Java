...
public class Serializator {
    public boolean serialization(Tour s, String fileName) throws FileNotFoundException {
    ...
    public Tour deserialization(String fileName) throws InvalidObjectException {
        ...
        try {   FileInputStream fis = new FileInputStream(fr);
            ...
            Tour st = (Tour)istream.readObject();
            return st;
